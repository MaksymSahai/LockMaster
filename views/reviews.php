<?php include_once ROOT.'/views/layout/header.php'?>
			...
			<div class="send-review">
				...
				<form method="POST" action="">
					...
					<input class="send-review-name" name="name" type="text" maxlength="50" placeholder="Введите Ваше имя" /></br>
					<p class="title send-review-subtitle">Ваш отзыв</p>
					<textarea class="send-review-text" name="comment" cols="40" rows="3" maxlength="2048" placeholder="Введите текст отзыва..."></textarea></br>
